...
namespace Sokan.Yastah.Business.Test.Characters
{
    ...
    public class CharacterGuildsOperationsTests
    {
        ...
        #region GetDivisionIdentityAsync() Tests

        [TestCaseSource(nameof(GuildId_DivisionId_TestCaseData))]
        public async Task GetDivisionIdentityAsync_RequirePermissionsAsyncFails_ReturnsImmediately(
            long guildId,
            long divisionId)
        {
            using var testContext = new TestContext();
            ...
            var result = await uut.GetDivisionIdentityAsync(
                guildId,
                divisionId,
                testContext.CancellationToken);
        ...
        [TestCaseSource(nameof(GuildId_DivisionId_TestCaseData))]
        public async Task GetDivisionIdentityAsync_RequirePermissionsAsyncSucceeds_ReturnsGetCurrentIdentityAsync(
            long guildId,
            long divisionId)
        {
            using var testContext = new TestContext();
            ...
            testContext.MockCharacterGuildsService
                .Setup(x => x.GetCurrentDivisionIdentityAsync(
                    It.IsAny<long>(),
                    It.IsAny<long>(),
                    It.IsAny<CancellationToken>()))
            ...
            testContext.MockCharacterGuildsService
                .ShouldHaveReceived(x => x.GetCurrentDivisionIdentityAsync(guildId, divisionId, testContext.CancellationToken));
        }

        #endregion GetDivisionIdentityAsync() Tests
        ...
        [TestCaseSource(nameof(GuildId_TestCaseData))]
        public async Task GetIdentityAsync_RequirePermissionsAsyncFails_ReturnsImmediately(
            long guildId)
        {
            using var testContext = new TestContext();
            ...
            var result = await uut.GetIdentityAsync(
                guildId,
                testContext.CancellationToken);
        ...
        [TestCaseSource(nameof(GuildId_TestCaseData))]
        public async Task GetIdentityAsync_RequirePermissionsAsyncSucceeds_ReturnsGetCurrentIdentityAsync(
            long guildId)
        {
            using var testContext = new TestContext();
            ...
            testContext.MockCharacterGuildsService
                .ShouldHaveReceived(x => x.GetCurrentIdentityAsync(guildId, testContext.CancellationToken));
        }

        #endregion GetIdentityAsync() Tests
