...
{
    [TestFixture]
    public class CharacterGuildVersionEntityTests
    {
        ...
        public static readonly IReadOnlyList<TestCaseData> Constructor_TestCaseData
            = new[]
            {
                /*                  id,             guildId,        name,           isDeleted,      creationId,     previousVersionId,  nextVersionId   */
        ...
        public void Constructor_Always_ReturnsIdentity(
            ...
            long? nextVersionId)
        {
            var result = new CharacterGuildVersionEntity(
                id,
                guildId,
                name,
                isDeleted,
